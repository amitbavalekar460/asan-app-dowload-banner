<?php
	/**
	 * Plugin Name:  Download Banner
	 * Plugin URI: http://asantechcube.com/
	 * Description: Display a download banner at the top of your website.
	 * Version: 2.0.6
	 * Author: Govind
	 * Author URI: http://asantechcube.com/
	 * 
	 */	
...
function download_com_content($content) {
  return $content . stripslashes_deep ( esc_attr ( get_option ( 'simple_banner_text' ) ) );
}
	?>
